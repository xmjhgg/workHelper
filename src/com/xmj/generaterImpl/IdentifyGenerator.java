...
public class IdentifyGenerator implements Generator {

    private static final Map<String, Integer> areaCode = new HashMap();

    private String randomAreCode() {
    ...
    private String randomBirthDay() {
        int year = (int)(Math.random() * 71.0D + 1950.0D);
        int month = (int)(Math.random() * 12.0D + 1.0D);
        int day = (int)(Math.random() * 30.0D + 1.0D);
        StringBuilder birthDayStr = new StringBuilder();
        birthDayStr.append(year);
        birthDayStr.append(month < 10 ? "0" + month : month);
        birthDayStr.append(day < 10 ? "0" + day : day);
        return birthDayStr.toString();
    }
    ...
    private char getValidateNum(char[] identify) {
        ...
        for(i = 0; i < n.length; ++i) {
            n[i] = Integer.parseInt(identify[i] + "");
        }
    ...
    private String generateIdentify() {
        String identifyStr = "";
        StringBuilder identify = new StringBuilder();
        identify.append(this.randomAreCode());
        identify.append(this.randomBirthDay());
        identify.append(this.randomOrderNum());
        identify.append(this.getValidateNum(identify.toString().toCharArray()));
        identifyStr = identifyStr + identify.toString();
        return identifyStr;
    }
